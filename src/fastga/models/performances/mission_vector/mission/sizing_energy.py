...
class SizingEnergy(om.ExplicitComponent):
    ...
    def setup(self):
        ...
        self.add_input("data:mission:sizing:main_route:climb:energy", val=0, units="W*h")
        self.add_input("data:mission:sizing:main_route:cruise:fuel", val=0, units="kg")
        self.add_input("data:mission:sizing:main_route:cruise:energy", val=0, units="W*h")
        self.add_input("data:mission:sizing:main_route:descent:fuel", val=0, units="kg")
        self.add_input("data:mission:sizing:main_route:descent:energy", val=0, units="W*h")
        self.add_input("data:mission:sizing:main_route:reserve:fuel", val=0, units="kg")
        self.add_input("data:mission:sizing:main_route:reserve:energy", val=0, units="W*h")
        self.add_input("data:mission:sizing:taxi_out:fuel", val=0, units="kg")
        self.add_input("data:mission:sizing:taxi_out:energy", val=0, units="W*h")
        self.add_input("data:mission:sizing:takeoff:fuel", val=0, units="kg")
        self.add_input("data:mission:sizing:takeoff:energy", val=0, units="W*h")
        self.add_input("data:mission:sizing:initial_climb:fuel", val=0, units="kg")
        self.add_input("data:mission:sizing:initial_climb:energy", val=0, units="W*h")
        self.add_input("data:mission:sizing:taxi_in:fuel", val=0, units="kg")
        self.add_input("data:mission:sizing:taxi_in:energy", val=0, units="W*h")
