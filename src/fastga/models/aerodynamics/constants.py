...
SUBMODEL_CD0_HYDROGEN_STORAGE = "submodel.aerodynamics.hydrogen_storage_cd0" #additional code
SUBMODEL_CD0_SUM = "submodel_aerodynamics.sum.cd0" #additional code
...
SUBMODEL_CD0_INLETS = "submodel.aerodynamics.inlets.cd0.legacy"
